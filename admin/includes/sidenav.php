        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            ?>
                ...
                <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)">
                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Admin / Delivery staff</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                    ...
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="add_admin_user.php">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;">Add Admin / Delivery staff</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    ...
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="manage_user.php">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;">Manage Admin / Delivery staff</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
