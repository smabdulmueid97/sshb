                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="add_admin_user.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;" >Add Admin or mod</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="manage_user.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;" >Manage or mod</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
